...
const MetricsRow = ({ toggl_list, airtable_list, asana_list }) => {
  return (
    <PropsContext.Consumer>
      {({
        ...
        <div class="row">
          <MetricTogglHours list={toggl_list} refresh={refreshToggl} />
          <MetricTogglCost list={toggl_list} refresh={refreshToggl} />
          <MetricAsanaTasksCompleted list={asana_list} refresh={refreshAsana} />
          <MetricAsanaTasksOverdue list={asana_list} refresh={refreshAsana} />
          <MetricAsanaTasksAge list={asana_list} refresh={refreshAsana} />
          <MetricAsanaTasksHygiene list={asana_list} refresh={refreshAsana} />
          <MetricAsanaTasks list={asana_list} refresh={refreshAsana} />
